...
from layint_runtime_api.models.resource_not_found_error import ResourceNotFoundError
...
class TestResourceNotFoundError(unittest.TestCase):
    ...
    def testResourceNotFoundError(self):
        ...
        #model = layint_runtime_api.models.resource_not_found_error.ResourceNotFoundError()
        pass
