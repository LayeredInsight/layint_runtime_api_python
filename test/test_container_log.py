...
from layint_runtime_api.models.container_log import ContainerLog


class TestContainerLog(unittest.TestCase):
    """ ContainerLog unit test stubs """
    ...
    def testContainerLog(self):
        """
        Test ContainerLog
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = layint_runtime_api.models.container_log.ContainerLog()
        pass
